...
def deap_eeg_preprocessing(eeg_data, sampling_rate=128):
    return np.transpose(eeg_data)


def exp1_0_eeg_preprocessing(eeg_data, channel_names=channel_names, sampling_rate=128):
